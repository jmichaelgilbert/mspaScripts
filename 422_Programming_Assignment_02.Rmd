...
```{r Ex9d1, indent = "    ", fig.width = 8, fig.height = 8}
...
temp <- rbind(accuracy(auto.m1), accuracy(auto.m2), accuracy(auto.m3), accuracy(auto.m4))
...
```{r Ex9f4, indent = "    "}
# Combine fit statistics across models
temp <- rbind(accuracy(auto.m1), accuracy(auto.m2), accuracy(auto.m3), accuracy(auto.m4), accuracy(auto.m5), accuracy(auto.m6), accuracy(auto.m7))
...
```{r Ex15a2, indent = "    ", fig.width = 8, fig.height = 8}
...
```{r Ex15d1, indent = "    ", fig.width = 8, fig.height = 8}
# Create loop for results
...
train.rn <- as.numeric(rownames(train))

# Fit linear regression model
auto.m8 <- lm(mpg ~ weight + year, data = auto, subset = train.rn)
...
round(predict(auto.m8, auto)[-train.rn], digits = 2)
```
...
```{r VSa4, indent = "        "}
# MSE
auto.m8.mse <- mean((auto$mpg - predict(auto.m8, auto))[-train.rn]^2)
auto.m8.mse
```
...
# Split data 60/40
train <- sample_frac(auto, 0.60)

# Assign row names of train
train.rn <- as.numeric(rownames(train))

# Fit linear regression model
auto.m9 <- lm(mpg ~ weight + year, data = auto, subset = train.rn)

# Print training values
round(auto.m9$fitted.values, digits = 2)

# Print predicted values for test data
round(predict(auto.m9, auto)[-train.rn], digits = 2)

# MSE
auto.m9.mse <- mean((auto$mpg - predict(auto.m9, auto))[-train.rn]^2)
auto.m9.mse
```
\
\
...
# Split data 70/30
train <- sample_frac(auto, 0.70)

# Assign row names of train
train.rn <- as.numeric(rownames(train))

# Fit linear regression model
auto.m10 <- lm(mpg ~ weight + year, data = auto, subset = train.rn)

# Print training values
round(auto.m10$fitted.values, digits = 2)

# Print predicted values for test data
round(predict(auto.m10, auto)[-train.rn], digits = 2)

# MSE
auto.m10.mse <- mean((auto$mpg - predict(auto.m10, auto))[-train.rn]^2)
auto.m10.mse
```
\
\
...
# Split data 80/20
train <- sample_frac(auto, 0.80)

# Assign row names of train
train.rn <- as.numeric(rownames(train))

# Fit linear regression model
auto.m11 <- lm(mpg ~ weight + year, data = auto, subset = train.rn)

# Print training values
round(auto.m11$fitted.values, digits = 2)

# Print predicted values for test data
round(predict(auto.m11, auto)[-train.rn], digits = 2)

# MSE
auto.m11.mse <- mean((auto$mpg - predict(auto.m11, auto))[-train.rn]^2)
auto.m11.mse
```
\
\
...
# Fit linear regression model
auto.m12 <- lm(mpg ~ weight*year, data = auto, subset = train.rn)

# Print training values
round(auto.m12$fitted.values, digits = 2)

# Print predicted values for test data
round(predict(auto.m12, auto)[-train.rn], digits = 2)

# MSE
auto.m12.mse <- mean((auto$mpg - predict(auto.m12, auto))[-train.rn]^2)
auto.m12.mse
```
...
auto.m13 <- lm(mpg ~ displacement, data = auto, subset = train.rn)
...
# Split data 70/30
train <- sample_frac(auto.nn, 0.70)

# Assign row names of train
train.rn <- as.numeric(rownames(train))

# Fit multiple linear regression model
auto.m14 <- lm(mpg ~ ., data = auto.nn, subset = train.rn)
