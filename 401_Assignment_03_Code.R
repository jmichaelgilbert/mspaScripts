...
round(quantile(, prob = c(0.025,0.975)), digits = 3)
#----------------------------------------------------------------------
...
Q2 <- quantile(births.t, prob=0.95, names = FALSE)
round(mu -Q2*sd(births)/sqrt(n), digits = 2)

Q2 <- quantile(births.t, prob=0.99, names = FALSE)
round(mu -Q2*sd(births)/sqrt(n), digits = 2)
...
Q2 <- quantile(personnel.t, prob=0.90, names = FALSE)
