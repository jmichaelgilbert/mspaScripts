...
data MB_Scored;
	...
	P_TARGET_WINS =
	((240.11157)				+
	(TEAM_BATTING_H			*	(0.06186))		+
	(TEAM_FIELDING_E		*	(-0.03835))		+
	(TEAM_BASERUN_SB_T99	*	(0.09427))		+
	(TEAM_BATTING_2B_T75	*	(-0.10400))		+
	(TEAM_BATTING_3B_T95	*	(0.12657))		+
	(TEAM_BATTING_BB_T75	*	(0.04799))		+
	(TEAM_FIELDING_DP_T99	*	(0.12222))		+
	(TEAM_BASERUN_SB_ln		*	(-5.32679))		+
	(TEAM_FIELDING_DP_ln	*	(-34.82363))	+
	(TEAM_FIELDING_E_T90_ln	*	(-15.52909)));
run; quit;
