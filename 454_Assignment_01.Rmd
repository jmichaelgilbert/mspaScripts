...
```{r DQC4, echo = F, out.width = "0.55\\linewidth"}
...
```{r DQC5, echo = F, out.width = "0.55\\linewidth"}
...
```{r EDA1, echo = F, out.width = "0.55\\linewidth"}
...
```{r EDA2, echo = F, out.width = "0.55\\linewidth"}
settings = list(box.rectangle = list(col = "black", fill = "beige"), 
                box.umbrella = list(col = "black"),
                plot.symbol = list(col = "black"))
