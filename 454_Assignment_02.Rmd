...
```{r EDA5, fig.width = 4.75, fig.height = 4}
...
```{r EDA6, fig.width = 4.75, fig.height = 8}
par(mfrow=c(2, 1))
...
```{r EDA7, fig.width = 4.75, fig.height = 8}
par(mfrow=c(2, 1))
...
```{r EDA8, fig.width = 4.75, fig.height = 8}
par(mfrow=c(2, 1))
fac.boxplot(tms, "channel", "price")
...
```{r EDA9, fig.width = 4.75, fig.height = 8}
par(mfrow=c(2, 1))
