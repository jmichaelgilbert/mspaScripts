...
This demo uses the `Auto` dataset from the `ISL` website (the version included in the `{ISLR}` package is slightly different). We'll start by importing the data and doing some minor tweaks based on a data quality check. Our response attribute is `mpg`. 
